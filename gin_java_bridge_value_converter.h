...
#ifndef ANDJS_JAVA_GIN_JAVA_BRIDGE_VALUE_CONVERTER_H_
#define ANDJS_JAVA_GIN_JAVA_BRIDGE_VALUE_CONVERTER_H_
...
#endif  // ANDJS_JAVA_GIN_JAVA_BRIDGE_VALUE_CONVERTER_H_
